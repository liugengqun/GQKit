...
- (void)addTag: (SKTag *)tag {
    ...
    if (tag.imageUrl.length > 0) {
        [btn  setImageForState:UIControlStateNormal withURL:[NSURL URLWithString:tag.imageUrl] placeholderImage:[tag.placeholderImage length] > 0 ? [UIImage imageNamed:tag.placeholderImage] : [UIImage imageNamed:@"占位图"]];
    }
