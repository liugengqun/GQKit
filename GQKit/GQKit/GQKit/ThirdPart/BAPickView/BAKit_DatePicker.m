...
- (void)ba_pickViewShowAnimation
{
    ...
    switch (self.animationType) {
        ...
        {
            [self.backView ba_animation_showFromPositionType:BAKit_ViewAnimationEnterDirectionTypeBottom duration:0.25f finishBlock:^{ //liugengqun
                BAKit_StrongSelf
                self.isAnimating = NO;
            }];
        }
...
- (void)ba_pickViewHiddenAnimation
{
    ...
    switch (self.animationType) {
        ...
        case BAKit_PickerViewAnimationTypeBottom:
        {
            [self.backView ba_animation_dismissFromPositionType:BAKit_ViewAnimationEnterDirectionTypeBottom duration:0.25f finishBlock:^{ // liugengqun
                BAKit_StrongSelf
                self.isAnimating = NO;
                self.backView.alpha = 0.1f;
                [self ba_removeSelf];
